        ...
        <div class="col-lg-4 col-md-6 mx-auto">
          ...
          <div
            ...
            <div class="accordion-item">
              <h2
                ...
                :id="
                  'heading' + result.vp_token.verifiableCredential.indexOf(data)
                ">
                <button
                ...
                <div class="accordion-body text-start">
                  ...
                  <div v-if="data.type[data.type.length - 1] == 'VerifiableId'">
                    ...
                    <span>
                      <i class="bi bi-check"></i>
                      Name At Birth:
                      {{ data.credentialSubject.nameAndFamilyNameAtBirth }}
                    </span>
                    <br />
                    <span>
                      <i class="bi bi-check"></i>
                    ...
                    <span>
                      <i class="bi bi-check"></i>
                      Current Address:
                      {{ data.credentialSubject.currentAddress }}
                    </span>
                    <br />
                    <span>
                      <i class="bi bi-check"></i>
                  ...
                  <div
                    v-if="
                      data.type[data.type.length - 1] == 'EuropeanBankIdentity'
                    ">
                    <span>
                      <i class="bi bi-check"></i>
          ...
          <div
            ...
            <span>
              ...
              >
              <a href="#" v-else class="text-dark" @click="viewAuthenticatedDID"
